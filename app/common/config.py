...
from ..core.entities import (
    DownloadResolutionEnum,
    FasterWhisperModelEnum,
    LLMServiceEnum,
    SubtitleDownloadTypeEnum,
    SubtitleLayoutEnum,
...
class Config(QConfig):
    ...
    faster_whisper_model = OptionsConfigItem(
        "FasterWhisper",
        "Model",
        FasterWhisperModelEnum.LARGE_V2,
    ...
    # ------------------- 视频下载配置 -------------------
    download_resolution = OptionsConfigItem(
        "Download",
        "Resolution",
        DownloadResolutionEnum.P1080,
        OptionsValidator(DownloadResolutionEnum),
        EnumSerializer(DownloadResolutionEnum),
    )
    subtitle_download_type = OptionsConfigItem(
        "Download",
        "SubtitleType",
        SubtitleDownloadTypeEnum.OFFICIAL_ONLY,
        OptionsValidator(SubtitleDownloadTypeEnum),
        EnumSerializer(SubtitleDownloadTypeEnum),
    )
    proxy_strict_mode = ConfigItem("Download", "ProxyStrict", True, BoolValidator())
    use_cookie_file = ConfigItem("Download", "UseCookie", False, BoolValidator())
