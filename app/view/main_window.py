...
from app.components.FasterWhisperSettingWidget import FasterWhisperDownloadDialog
from app.config import ASSETS_PATH, GITHUB_REPO_URL, MODEL_PATH
...
class MainWindow(FluentWindow):
    ...
    def switchTo(self, interface):
        if interface.windowTitle():
            ...
            self.setWindowTitle(self.tr("down-video-load"))
    ...
    def onGithubDialog(self):
        ...
        w = MessageBox(
            self.tr("GitHub信息"),
            self.tr(
                "down-video-load 由本人在课余时间独立开发完成，目前托管在GitHub上，欢迎Star和Fork。项目诚然还有很多地方需要完善，遇到软件的问题或者BUG欢迎提交Issue。\n\n https://github.com/WEIFENG2333/down-video-load"
            ),
            self,
        )
